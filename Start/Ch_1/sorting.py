...
# TODO: the sorted() function can be used to return a new list with sorted data and doesn't change the original list
...
data["features"].sort(reverse=True, key=getmag)
for i in range(0, 10):
